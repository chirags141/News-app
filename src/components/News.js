...
const News = (props) => {
      ...
      document.title = `${capitalizeFirstLetter(props.category)} - Reliable News`;
    ...
    return (
      <>
        <h2 style={{textAlign:"center",margin:'35px 0px',marginTop:'90px'}}> Top Headlines - {capitalizeFirstLetter(props.category)}</h2>
