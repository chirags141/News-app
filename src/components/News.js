...
export class News extends Component {
   ...
   async componentDidMount(){
     let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=2f9deb4187114baeaf5ef6c23c88e6e4&page=1&pageSize=${this.props.pageSize}`
   ...
   handlePrevClick = async ()=>{
    //  console.log("prev")
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=2f9deb4187114baeaf5ef6c23c88e6e4&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
    this.setState({loading : true })
    let data = await fetch(url);
    let parsedData =await data.json()
